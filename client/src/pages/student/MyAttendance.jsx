...
const MyAttendance = () => {
  ...
  const fetchData = async (studentId) => {
    ...
    try {
      ...
      const studentRes = await fetch(`${BASE_URL}/api/students?studentId=${studentId}`, { headers });
      ...
      const attRes = await fetch(`${BASE_URL}/api/attendance/student/${matched._id}`, { headers });
